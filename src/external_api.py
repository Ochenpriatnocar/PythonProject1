...
def transactions_by_rub(operation):
    ...
    elif operation["operationAmount"]["currency"]["code"] == "EUR" or operation["operationAmount"]["currency"]["code"] == "USD":
        payload = {"to": "RUB", "from": {operation["operationAmount"]["currency"]["code"]}, "amount": {operation["operationAmount"]["amount"]}}
